...
def generate_barcode():
    ...
    # barcode_zip_email_concat = zip_code.get()+t+phone.get()+t+email.get()
    # zip_email_barcode = tp.generate_barcode('datamatrix', data=barcode_zip_email_concat)
    # zip_email_barcode.convert('1').save(user_path+r'\Documents\Barcodes\zip_email_barcode.png')

    # alias_text = alias.get()
    # ship_from_name_text = ship_from_name.get()
    # ship_from_phone_text = ship_from_phone.get()
    # company_name_text = company_name.get()
    # contact_name_text = contact_name.get()
    # address_line1_text = address_line1.get()
    # address_line2_text = address_line2.get()
    # address_line3_text = address_line3.get()
    # city_text = city.get()
    # country_text = country.get()
    # state_text = state.get()
    # zip_code_text = zip_code.get()
...
#        0,
#        "print",
#        user_path+r'\Documents\Barcodes\pdf_generated.pdf',
...
packaged_img=Image.open(user_path+r'\OneDrive - Microsoft\Documents\Barcode_Test\packaged_logo.png').resize((135,34))
